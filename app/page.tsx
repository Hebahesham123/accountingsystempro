...
// formatCurrency is defined locally below for dashboard display
...
export default function HomePage() {
  ...
  const isRegular = isRegularUser(currentUser)
  ...
  // Load dashboard data (all hooks MUST be above any conditional return)
  useEffect(() => {
    if (isRegular) return // Skip loading for regular users
