-- Complete Chart of Accounts Migration Script
...
-- Insert main account categories (header accounts) - only if they don't exist
...
-- Insert sample sub-accounts - only if they don't exist
INSERT INTO accounts (id, code, name, description, account_type_id, parent_account_id, level, is_active, is_header) VALUES
    -- Current Assets
